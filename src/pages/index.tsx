  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless automation with Mouse - your solution for precise cursor movement and click execution. Perfect for interaction, task automation, and UI testing."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661956602116-aa6865609028?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxhdXRvbWF0aW9ufGVufDB8fHx8MTY4OTg5NzM0NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless automation with Mouse - your solution for precise cursor movement and click execution. Perfect for interaction, task automation, and UI testing.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Developer" type="developer" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
